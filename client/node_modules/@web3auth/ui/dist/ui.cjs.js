...
"use strict";
module.exports = JSON.parse('{"modal":{"adapter-loader":{"message":"Bestätigen Sie Ihr {{adapter}}-Konto, um fortzufahren"},"external":{"title":"Externe Geldbörse","walletconnect-subtitle":"QR-Code mit einem WalletConnect-kompatiblen Wallet scannen","walletconnect-connect":"Verbinden","connect":"Verbinden Sie sich mit Wallet","back":"Der Rücken"},"footer":{"message":"Selbstverwahrungs-Login durch","terms":"Nutzungsbedingungen","policy":"Datenschutz-Bestimmungen"},"network":{"switch-request":"Diese Website fordert einen Netzwerkwechsel an","to":"Zu","cancel":"Absagen","proceed":"Fortfahren","add-request":"Diese Website fordert das Hinzufügen eines Netzwerks an","from":"Aus"},"social":{"email":"Email","view-more":"Weitere Optionen anzeigen","email-continue":"Fahren Sie mit E-Mail fort","continue":"Weitermachen mit","view-less":"Weniger Optionen anzeigen"},"header-subtitle":"Wählen Sie eine der folgenden Optionen aus, um fortzufahren","header-title":"Einloggen"}}');
...
"use strict";
module.exports = JSON.parse('{"modal":{"adapter-loader":{"message":"続行するには、{{adapter}} アカウントで確認してください"},"external":{"title":"外部ウォレット","walletconnect-subtitle":"WalletConnect対応ウォレットでQRコードをスキャン","walletconnect-connect":"接続","connect":"ウォレットと接続","back":"戻る"},"footer":{"message":"による自己管理ログイン","terms":"利用規約","policy":"プライバシーポリシー"},"network":{"switch-request":"このサイトはネットワークの切り替えを要求しています","to":"に","cancel":"キャンセル","proceed":"続行","add-request":"このサイトはネットワークの追加をリクエストしています","from":"から"},"social":{"email":"Eメール","view-more":"その他のオプションを表示","email-continue":"メールで続行","continue":"続ける","view-less":"オプションを少なく表示"},"header-subtitle":"次のいずれかを選択して続行します","header-title":"ログイン"}}');
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "LoginModal": () => (/* reexport */ loginModal),
  ...
  "languageMap": () => (/* reexport */ languageMap),
...
;// CONCATENATED MODULE: ./src/i18n/english.json
const english_namespaceObject = JSON.parse('{"modal":{"adapter-loader":{"message":"Verify on your {{adapter}} account to continue"},"external":{"title":"External wallet","walletconnect-subtitle":"Scan QR code with a WalletConnect-compatible wallet","walletconnect-connect":"Connect","connect":"Connect with Wallet","back":"Back"},"footer":{"message":"Self-custodial login by","terms":"Terms of use","policy":"Privacy policy"},"network":{"switch-request":"This site is requesting to switch Network","to":"To","cancel":"Cancel","proceed":"Proceed","add-request":"This site is requesting to add Network","from":"From"},"social":{"email":"Email","view-more":"View more options","email-continue":"Continue with Email","continue":"Continue with","view-less":"View less options"},"header-subtitle":"Select one of the following to continue","header-title":"Sign in"}}');
// EXTERNAL MODULE: ./src/i18n/german.json
var german = __webpack_require__(808);
// EXTERNAL MODULE: ./src/i18n/japanese.json
var japanese = __webpack_require__(157);
// EXTERNAL MODULE: ./src/i18n/korean.json
var korean = __webpack_require__(27);
// EXTERNAL MODULE: ./src/i18n/mandarin.json
var mandarin = __webpack_require__(55);
// EXTERNAL MODULE: ./src/i18n/spanish.json
var spanish = __webpack_require__(851);
...
;// CONCATENATED MODULE: ./src/localeImport.ts



// import { de, en, es, ja, ko, zh } from "./i18n";

external_i18next_default().use(external_react_i18next_namespaceObject.initReactI18next).init({
  resources: {
    en: {
      translation: english_namespaceObject
    }
    // de: { translation: de },
    // es: { translation: es },
    // ja: { translation: ja },
...
/* harmony default export */ const localeImport = ((/* unused pure expression or super */ null && (i18n)));
...
function DetailedLoader(props) {
  ...
  var _useTranslation = (0,external_react_i18next_namespaceObject.useTranslation)(),
        ...
        children: [modalStatus === MODAL_STATUS.CONNECTING && /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: t("modal.adapter-loader.message", {
                adapter: adapter
              })
            })
          })]
          ...
          return deviceDetails.os === (external_bowser_default()).OS_MAP.iOS ? /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsx)("a", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsx)("button", {
                ...
                children: t("modal.external.walletconnect-connect")
              })
            }, link.name)
          });
        })
...
function ExternalWallet(props) {
  ...
  var _useState3 = (0,external_react_.useState)({}),
    ...
    adapterVisibilityMap = _useState4[0],
    setAdapterVisibilityMap = _useState4[1];
  var deviceType = (0,external_react_.useMemo)(function () {
    var browser = external_bowser_default().getParser(window.navigator.userAgent);
  ...
  (0,external_react_.useEffect)(function () {
    ...
    var canShowMap = {};
    Object.keys(config).forEach(function (adapter) {
      var adapterConfig = config[adapter];
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [showBackButton && /*#__PURE__*/(0,jsx_runtime.jsxs)("button", {
        ...
        children: Object.keys(config).map(function (adapter) {
          ...
          return adapterVisibilityMap[adapter] && /*#__PURE__*/(0,jsx_runtime.jsxs)("li", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [appLogo ? /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          ...
          children: t("modal.header-subtitle")
        })]
      })]
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("input", {
        ...
        className: "w3a-button",
        type: "submit",
        children: t("modal.social.email-continue")
      })]
    })]
  });
}
...
function SocialLogins(props) {
  ...
  var adapterExpandText = isExpanded ? t("modal.social.view-less") : t("modal.social.view-more");
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "w3ajs-social-logins w3a-group",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "w3a-group__title",
      children: t("modal.social.continue")
...
var LoginModal = /*#__PURE__*/function (_SafeEventEmitter) {
  ...
  function LoginModal(_ref) {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "defaultLanguage", void 0);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              useLang = _this.defaultLanguage || "en"; // Load new language resource
              if (useLang === "de") {
                Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 808, 19)).then(function (messages) {
                  external_i18next_default().addResourceBundle(useLang, "translation", messages.default);
                  return external_i18next_default().changeLanguage(useLang);
                }).catch(function (error) {
                  base_namespaceObject.log.error(error);
                });
              } else if (useLang === "ja") {
                Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 157, 19)).then(function (messages) {
                  external_i18next_default().addResourceBundle(useLang, "translation", messages.default);
                  return external_i18next_default().changeLanguage(useLang);
                }).catch(function (error) {
                  base_namespaceObject.log.error(error);
                ...
                Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 27, 19)).then(function (messages) {
                  external_i18next_default().addResourceBundle(useLang, "translation", messages.default);
                  return external_i18next_default().changeLanguage(useLang);
                }).catch(function (error) {
                  base_namespaceObject.log.error(error);
                ...
                Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 55, 19)).then(function (messages) {
                  external_i18next_default().addResourceBundle(useLang, "translation", messages.default);
                  return external_i18next_default().changeLanguage(useLang);
                }).catch(function (error) {
                  base_namespaceObject.log.error(error);
                ...
                Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 851, 19)).then(function (messages) {
                  external_i18next_default().addResourceBundle(useLang, "translation", messages.default);
                  return external_i18next_default().changeLanguage(useLang);
                }).catch(function (error) {
                  base_namespaceObject.log.error(error);
              ...
              return _context.abrupt("return", new Promise(function (resolve) {
                ...
                root.render( /*#__PURE__*/(0,jsx_runtime.jsx)(ThemedContext.Provider, {
                  value: darkState,
...
/* harmony default export */ const loginModal = (LoginModal);
// EXTERNAL MODULE: ./css/network.css
var network = __webpack_require__(883);
// EXTERNAL MODULE: external "react-dom"
var external_react_dom_ = __webpack_require__(137);
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  (0,external_react_dom_.render)( /*#__PURE__*/(0,jsx_runtime.jsx)(components_AddNetwork, {
                    appOrigin: appOrigin,
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  (0,external_react_dom_.render)( /*#__PURE__*/(0,jsx_runtime.jsx)(components_SwitchNetwork, {
                    appOrigin: appOrigin,
