...
var modal = {
	...
	network: {
		"switch-request": "This site is requesting to switch Network",
		to: "To",
		cancel: "Cancel",
		proceed: "Proceed",
		"add-request": "This site is requesting to add Network",
		from: "From"
	},
	social: {
		email: "Email",
...
function DetailedLoader(props) {
  ...
  return modalStatus !== MODAL_STATUS.INITIALIZED ? jsxs("div", Object.assign({
    ...
    children: [jsxs("div", Object.assign({
      ...
      children: [jsxs("div", Object.assign({
        ...
        }), modalStatus === ADAPTER_STATUS.CONNECTED && jsx("div", Object.assign({
          className: "w3ajs-modal-loader__message w3a-spinner-message"
        }, {
          children: message
        })), modalStatus === ADAPTER_STATUS.ERRORED && jsx("div", Object.assign({
    ...
    })), (modalStatus === ADAPTER_STATUS.CONNECTED || modalStatus === ADAPTER_STATUS.ERRORED) && jsx("button", Object.assign({
      type: "button",
  ...
  return modalStatus !== MODAL_STATUS.INITIALIZED ? jsxs("div", Object.assign({
    ...
    children: [jsxs("div", Object.assign({
      ...
      children: [jsxs("div", Object.assign({
        ...
        children: [modalStatus === MODAL_STATUS.CONNECTING && jsxs("div", Object.assign({
...
function WalletConnect(props) {
  ...
  return jsx("div", Object.assign({
    ...
    children: jsxs("div", Object.assign({
      ...
      children: [jsx("div", Object.assign({
      ...
      })), deviceDetails.platform === bowser.PLATFORMS_MAP.desktop ? jsxs("div", Object.assign({
        ...
        children: links.map(function (link) {
          return deviceDetails.os === bowser.OS_MAP.iOS ? jsx("div", Object.assign({
...
function ExternalWallet(props) {
  ...
  useEffect(function () {
    ...
    var wcAvailable = (((_a = config[WALLET_ADAPTERS.WALLET_CONNECT_V1]) === null || _a === void 0 ? void 0 : _a.showOnModal) || false) !== false;
  ...
  return jsx("div", Object.assign({
    ...
    children: jsxs("div", Object.assign({
      ...
      children: [showBackButton && jsxs("button", Object.assign({
        type: "button",
        ...
        return null;
      }), modalStatus === MODAL_STATUS.INITIALIZED && jsx("ul", Object.assign({
        ...
        children: Object.keys(config).map(function (adapter) {
          ...
          return adapterVisibilityMap[adapter] && jsxs("li", Object.assign({
            ...
            children: [jsx("button", Object.assign({
              ...
              children: ((_a = config[adapter]) === null || _a === void 0 ? void 0 : _a.label) || adapter
            }))]
          }), adapter);
        })
      }))]
...
function SocialLogins(props) {
  ...
  return jsxs("div", Object.assign({
    ...
    })), canShowMore && jsxs("button", Object.assign({
      type: "button",
...
function Modal(props) {
  ...
  var externalWalletButton = jsx("div", Object.assign({
    className: "w3ajs-external-wallet w3a-group"
  }, {
    children: jsxs("div", Object.assign({
  ...
  var areSocialLoginsVisible = useMemo(function () {
    ...
    if (Object.keys(((_a = modalState.socialLoginsConfig) === null || _a === void 0 ? void 0 : _a.loginMethods) || {}).length === 0) return false;
    var isAnySocialLoginVisible = Object.entries(((_b = modalState.socialLoginsConfig) === null || _b === void 0 ? void 0 : _b.loginMethods) || {}).some(function (_ref) {
    ...
    return false;
  }, [modalState.showExternalWalletsOnly, (_a = modalState.socialLoginsConfig) === null || _a === void 0 ? void 0 : _a.loginMethods]);
  log.info("modal state", modalState, areSocialLoginsVisible);
  var isEmailPassworedlessLoginVisible = useMemo(function () {
    var _a, _b;
    return (_b = (_a = modalState.socialLoginsConfig) === null || _a === void 0 ? void 0 : _a.loginMethods[LOGIN_PROVIDER.EMAIL_PASSWORDLESS]) === null || _b === void 0 ? void 0 : _b.showOnModal;
  }, [(_b = modalState.socialLoginsConfig) === null || _b === void 0 ? void 0 : _b.loginMethods]);
  var modalClassName = "w3a-modal ".concat(isDark ? "" : " w3a-modal--light");
  return modalState.modalVisibilityDelayed && jsx("div", Object.assign({
    id: "w3a-modal",
    ...
    children: jsxs("div", Object.assign({
      ...
      children: [jsx(memoizedHeader, {
        onClose: closeModal,
        appLogo: appLogo
      }), modalState.status !== MODAL_STATUS.INITIALIZED ? jsx("div", Object.assign({
        ...
        children: (areSocialLoginsVisible || isEmailPassworedlessLoginVisible) && !modalState.externalWalletsVisibility ? jsxs(Fragment, {
          children: [areSocialLoginsVisible ? jsx(SocialLogins, {
            ...
            adapter: (_c = modalState.socialLoginsConfig) === null || _c === void 0 ? void 0 : _c.adapter,
            handleSocialLoginClick: function handleSocialLoginClick(params) {
              return preHandleSocialWalletClick(params);
            }
...
var LoginModal = /*#__PURE__*/function (_SafeEventEmitter) {
  ...
  function LoginModal(_ref) {
    ...
    _this.displayErrorsOnModal = true;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                useLang = this.defaultLanguage || "en"; // Load new language resource
                if (useLang === "de") {
                  import('./german-accb2072.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  });
                } else if (useLang === "ja") {
                  import('./japanese-f51959d8.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./korean-f9e31318.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./mandarin-bd78ed9f.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./spanish-3612552d.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                ...
                return _context.abrupt("return", new Promise(function (resolve) {
                  _this2.stateEmitter.once("MOUNTED", function () {
                    log.info("rendered");
                    _this2.setState({
                      status: MODAL_STATUS.INITIALIZED
                    });
                  ...
                  var container = createWrapper$1();
                  var root = createRoot(container);
                  root.render(jsx(ThemedContext.Provider, Object.assign({
                    value: darkState
                  }, {
                    children: jsx(Modal, {
                      closeModal: _this2.closeModal,
                      stateListener: _this2.stateEmitter,
                      handleShowExternalWallets: function handleShowExternalWallets(externalWalletsInitialized) {
                        return _this2.handleShowExternalWallets(externalWalletsInitialized);
                      },
                      handleExternalWalletClick: function handleExternalWalletClick(params) {
                        return _this2.handleExternalWalletClick(params);
                      },
                      handleSocialLoginClick: function handleSocialLoginClick(params) {
                        return _this2.handleSocialLoginClick(params);
                      },
                      appLogo: _this2.appLogo,
    ...
    _this.addSocialLogins = function (adapter, loginMethods, loginMethodsOrder) {
      _this.setState({
        socialLoginsConfig: {
          adapter: adapter,
    ...
    _this.addWalletLogins = function (externalWalletsConfig, options) {
      _this.setState({
        externalWalletsConfig: externalWalletsConfig,
        externalWalletsInitialized: true,
        showExternalWalletsOnly: !!(options === null || options === void 0 ? void 0 : options.showExternalWalletsOnly),
        externalWalletsVisibility: true
      });
    };
    _this.open = function () {
    ...
    _this.initExternalWalletContainer = function () {
      _this.setState({
        hasExternalWallets: true
      });
    };
    _this.handleShowExternalWallets = function (status) {
      _this.emit(LOGIN_MODAL_EVENTS.INIT_EXTERNAL_WALLETS, {
        externalWalletsInitialized: status
      });
    };
    _this.handleExternalWalletClick = function (params) {
    ...
    _this.handleSocialLoginClick = function (params) {
    ...
    _this.updateWalletConnect = function (walletConnectUri, wcAdapters) {
    ...
    _this.handleAdapterData = function (adapterData) {
    ...
    _this.subscribeCoreEvents = function (listener) {
...
function AddNetwork(props) {
  ...
  return showModal && jsx("div", Object.assign({
...
var NetworkSwitch = /*#__PURE__*/function (_BaseNetworkSwitch) {
  ...
  _createClass(NetworkSwitch, [{
    key: "addNetwork",
    value: function addNetwork(params) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    ...
    key: "switchNetwork",
    value: function switchNetwork(params) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
...
export { LOGIN_MODAL_EVENTS, LoginModal, MODAL_STATUS, NetworkSwitch, OPENLOGIN_PROVIDERS, LoginModal as default, getAdapterSocialLogins, getNetworkIconId, languageMap, validateImageUrl };
