...
var SolanaWalletAdapter = /*#__PURE__*/function (_BaseSolanaAdapter) {
  inherits_default()(SolanaWalletAdapter, _BaseSolanaAdapter);
  var _super = _createSuper(SolanaWalletAdapter);
  function SolanaWalletAdapter(params) {
    var _this;
    classCallCheck_default()(this, SolanaWalletAdapter);
    _this = _super.call(this, params);
    defineProperty_default()(assertThisInitialized_default()(_this), "name", base_namespaceObject.WALLET_ADAPTERS.TORUS_SOLANA);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "solanaProvider", null);
  ...
  createClass_default()(SolanaWalletAdapter, [{
    key: "provider",
    get: function get() {
    ...
    value: function () {
      var _init = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(options) {
        var network, _ref, blockExplorer, displayName, ticker, tickerName, rpcTarget, chainId, _ref2, _chainId, _blockExplorer, _displayName, _rpcTarget, _ticker, _tickerName;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                get_default()(getPrototypeOf_default()(SolanaWalletAdapter.prototype), "checkInitializationRequirements", this).call(this);
                ...
                if (!this.chainConfig) {
                  ...
                  _ref = this.chainConfig, blockExplorer = _ref.blockExplorer, displayName = _ref.displayName, ticker = _ref.ticker, tickerName = _ref.tickerName, rpcTarget = _ref.rpcTarget, chainId = _ref.chainId;
                  network = {
                    chainId: chainId,
                    rpcTarget: rpcTarget,
                  ...
                  _ref2 = this.chainConfig, _chainId = _ref2.chainId, _blockExplorer = _ref2.blockExplorer, _displayName = _ref2.displayName, _rpcTarget = _ref2.rpcTarget, _ticker = _ref2.ticker, _tickerName = _ref2.tickerName;
                  network = {
                    chainId: _chainId,
              ...
              case 17:
                ...
                base_namespaceObject.log.error("Failed to connect with cached torus solana provider", _context.t0);
    ...
    value: function () {
      var _connect = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
        var torusInpageProvider, _ref3, chainId, blockExplorer, displayName, rpcTarget, ticker, tickerName, network;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                get_default()(getPrototypeOf_default()(SolanaWalletAdapter.prototype), "checkConnectionRequirements", this).call(this);
              ...
              case 20:
                ...
                if (!(_context2.t0 instanceof base_namespaceObject.Web3AuthError && _context2.t0.code === 5010)) {
                  _context2.next = 29;
                  break;
                }
                _ref3 = this.chainConfig, chainId = _ref3.chainId, blockExplorer = _ref3.blockExplorer, displayName = _ref3.displayName, rpcTarget = _ref3.rpcTarget, ticker = _ref3.ticker, tickerName = _ref3.tickerName;
                network = {
                  chainId: chainId,
                  rpcTarget: rpcTarget,
                  blockExplorerUrl: blockExplorer,
              ...
              case 36:
                ...
                this.emit(base_namespaceObject.ADAPTER_EVENTS.ERRORED, _context2.t1);
        ...
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                _context3.next = 5;
                return get_default()(getPrototypeOf_default()(SolanaWalletAdapter.prototype), "disconnect", this).call(this);
              case 5:
                _context3.next = 7;
