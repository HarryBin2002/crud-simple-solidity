...
var BaseSolanaAdapter = /*#__PURE__*/function (_BaseAdapter) {
  inherits_default()(BaseSolanaAdapter, _BaseAdapter);
  ...
  function BaseSolanaAdapter() {
    ...
    classCallCheck_default()(this, BaseSolanaAdapter);
  ...
  createClass_default()(BaseSolanaAdapter, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 21:
                ...
                _context.next = 24;
                return (0,base_namespaceObject.verifySignedChallenge)(chainNamespace, external_bs58_default().encode(signedMessage), challenge, this.name, this.sessionTime, this.clientId);
