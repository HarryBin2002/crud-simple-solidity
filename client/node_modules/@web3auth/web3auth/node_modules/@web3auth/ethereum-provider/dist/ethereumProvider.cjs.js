...
__webpack_require__.d(__webpack_exports__, {
  ...
  "getProviderHandlers": () => (/* reexport */ ethPrivatekeyUtils_getProviderHandlers)
});
...
function createWalletMiddleware(_ref) {
  ...
  function _validateAndNormalizeKeyholder() {
    _validateAndNormalizeKeyholder = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(address, req) {
  ...
  function _lookupAccounts() {
    _lookupAccounts = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(req, res) {
  ...
  function _lookupDefaultAccount() {
    _lookupDefaultAccount = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(req, res) {
      var accounts;
  ...
  function _sendTransaction() {
    _sendTransaction = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4(req, res) {
      var txParams;
  ...
  function _signTransaction() {
    _signTransaction = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5(req, res) {
      var txParams;
  ...
  function _ethSign() {
    _ethSign = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6(req, res) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              msgParams = _objectSpread(_objectSpread({}, extraParams), {}, {
                from: address,
                data: message
              });
              _context6.next = 10;
  ...
  function _signTypedData() {
    _signTypedData = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7(req, res) {
  ...
  function _signTypedDataV() {
    _signTypedDataV = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(req, res) {
  ...
  function _signTypedDataV2() {
    _signTypedDataV2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(req, res) {
      var address, message, version, msgParams;
  ...
  function _personalSign() {
    _personalSign = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee10(req, res) {
  ...
  function _encryptionPublicKey() {
    _encryptionPublicKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee11(req, res) {
      var address;
  ...
  function _decryptMessage() {
    _decryptMessage = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee12(req, res) {
  ...
  function _fetchPrivateKey() {
    _fetchPrivateKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee13(req, res) {
...
function createEthMiddleware(providerHandlers) {
  ...
  var ethMiddleware = (0,openlogin_jrpc_namespaceObject.mergeMiddleware)([(0,openlogin_jrpc_namespaceObject.createScaffoldMiddleware)({
    eth_syncing: false
...
function createChainSwitchMiddleware(_ref) {
  ...
  function _addNewChain() {
    _addNewChain = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(req, res) {
      var _req$params;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("Missing chain params");
            ...
            case 3:
              ...
              throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("Missing chainId in chainParams");
            ...
            case 5:
              ...
              throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("Missing rpcUrls in chainParams");
            ...
            case 7:
              ...
              throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("Missing nativeCurrency in chainParams");
  ...
  function _updateChain() {
    _updateChain = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(req, res) {
      var _req$params2;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("Missing chainId");
...
function createAccountMiddleware(_ref2) {
  ...
  function _updateAccount() {
    _updateAccount = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(req, res) {
      var _req$params3;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("Missing privateKey");
...
function createJsonRpcClient(providerConfig) {
  ...
  var fetchMiddleware = (0,base_controllers_namespaceObject.createFetchMiddleware)({
    rpcTarget: rpcTarget
  });
  var networkMiddleware = (0,openlogin_jrpc_namespaceObject.mergeMiddleware)([createChainIdMiddleware(chainId), createProviderConfigMiddleware(providerConfig), fetchMiddleware]);
  return {
...
function getProviderHandlers(_ref) {
  ...
  return {
    getPrivateKey: function () {
      var _getPrivateKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee() {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    getAccounts: function () {
      var _getAccounts = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(_) {
        var accounts;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
    ...
    processTransaction: function () {
      var _processTransaction = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(txParams, _) {
        var result;
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
    ...
    processSignTransaction: function () {
      var _processSignTransaction = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4(txParams, _) {
        var result;
        return regenerator_default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
    ...
    processEthSignMessage: function () {
      var _processEthSignMessage = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5(msgParams, _) {
        var result;
        return regenerator_default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
    ...
    processPersonalMessage: function () {
      var _processPersonalMessage = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6(msgParams, _) {
        var result;
        return regenerator_default().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
    ...
    processTypedMessage: function () {
      var _processTypedMessage = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7(msgParams, _) {
        var result;
        return regenerator_default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
    ...
    processTypedMessageV3: function () {
      var _processTypedMessageV = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(msgParams) {
        var result;
        return regenerator_default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
    ...
    processTypedMessageV4: function () {
      var _processTypedMessageV2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(msgParams) {
        var result;
        return regenerator_default().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
    ...
    processEncryptionPublicKey: function () {
      var _processEncryptionPublicKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee10(_) {
        return regenerator_default().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
...
var WalletConnectProvider = /*#__PURE__*/function (_BaseProvider) {
  inherits_default()(WalletConnectProvider, _BaseProvider);
  ...
  function WalletConnectProvider(_ref) {
    ...
    classCallCheck_default()(this, WalletConnectProvider);
  ...
  createClass_default()(WalletConnectProvider, [{
    key: "enable",
    value: function () {
      var _enable = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee() {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw external_eth_rpc_errors_namespaceObject.ethErrors.provider.custom({
    ...
    key: "setupProvider",
    value: function () {
      var _setupProvider = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(connector) {
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: "switchChain",
    value: function () {
      var _switchChain = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(_ref2) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 12:
                ...
                base_namespaceObject.log.error(_context3.t0);
              ...
              case 20:
                ...
                base_namespaceObject.log.error(_context3.t1); // ignore this error because metamask & others return provider.result as null
    ...
    key: "addChain",
    value: function () {
      var _addChain = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4(chainConfig) {
        ...
        return regenerator_default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                get_default()(getPrototypeOf_default()(WalletConnectProvider.prototype), "addChain", this).call(this, chainConfig);
              ...
              case 9:
                ...
                base_namespaceObject.log.error(_context4.t0);
                throw _context4.t0;
    ...
    key: "lookupNetwork",
    value: function () {
      var _lookupNetwork = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5(connector) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                throw base_namespaceObject.WalletLoginError.notConnectedError("Wallet connect connector is not connected");
              ...
              case 4:
                ...
                connectedHexChainId = (0,base_namespaceObject.isHexStrict)(connector.chainId.toString()) ? connector.chainId : "0x".concat(connector.chainId.toString(16));
                ...
                throw base_namespaceObject.WalletInitializationError.rpcConnectionError("Invalid network, net_version is: ".concat(connectedHexChainId, ", expected: ").concat(chainId));
    ...
    key: "setupEngine",
    value: function () {
      var _setupEngine = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6(connector) {
    ...
    value: function () {
      var _onConnectorStateUpdate = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(connector) {
        var _this2 = this;
            ...
            switch (_context8.prev = _context8.next) {
              case 0:
                connector.on("session_update", /*#__PURE__*/function () {
                  var _ref3 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7(error, payload) {
                      ...
                      while (1) {
                        switch (_context7.prev = _context7.next) {
                          ...
                          case 5:
                            ...
                            maybeConfig = (0,base_namespaceObject.getChainConfig)(base_namespaceObject.CHAIN_NAMESPACES.EIP155, connectedChainId) || {}; // Handle rpcUrl update
...
}(base_provider_namespaceObject.BaseProvider);

defineProperty_default()(WalletConnectProvider, "getProviderInstance", /*#__PURE__*/function () {
  var _ref4 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(params) {
    var providerFactory;
    return regenerator_default().wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
...
var BIG_NUMBER_WEI_MULTIPLIER = new (external_bignumber_js_default())("1e18");
var BIG_NUMBER_GWEI_MULTIPLIER = new (external_bignumber_js_default())("1e9");
var BIG_NUMBER_ETH_MULTIPLIER = new (external_bignumber_js_default())("1"); // Setter Maps

var toBigNumber = {
  hex: function hex(n) {
    return typeof n === "string" ? new (external_bignumber_js_default())((0,external_ethereumjs_util_namespaceObject.stripHexPrefix)(n), 16) : new (external_bignumber_js_default())(n, 16);
  },
  dec: function dec(n) {
    return new (external_bignumber_js_default())(n, 10);
  }
};
...
var toSpecifiedDenomination = {
  WEI: function WEI(bigNumber) {
    return bigNumber.times(BIG_NUMBER_WEI_MULTIPLIER).dp(0, (external_bignumber_js_default()).ROUND_HALF_UP);
  },
  GWEI: function GWEI(bigNumber) {
    return bigNumber.times(BIG_NUMBER_GWEI_MULTIPLIER).dp(9, (external_bignumber_js_default()).ROUND_HALF_UP);
  },
  ETH: function ETH(bigNumber) {
    return bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).dp(9, (external_bignumber_js_default()).ROUND_HALF_UP);
  }
};
var baseChange = {
  hex: function hex(n) {
  ...
  dec: function dec(n) {
    return new (external_bignumber_js_default())(n).toString(10);
  }
};
...
function _fetchEip1159GasEstimates() {
  _fetchEip1159GasEstimates = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(url) {
    ...
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,http_helpers_namespaceObject.get)(url);

          case 2:
            estimates = _context.sent;
            normalizedEstimates = utils_objectSpread(utils_objectSpread({}, estimates), {}, {
...
function _fetchLegacyGasPriceEstimates() {
  _fetchLegacyGasPriceEstimates = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(url) {
    var result;
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var validateTypedMessageParams = function validateTypedMessageParams(parameters, activeChainId) {
  ...
  try {
    external_assert_default().ok(parameters && typeof_default()(parameters) === "object", "Params must be an object.");
    ...
    external_assert_default().ok(typeof parameters.from === "string" && (0,external_ethereumjs_util_namespaceObject.isValidAddress)(parameters.from), '"from" field must be a valid, lowercase, hexadecimal Ethereum address string.');
    var data = null;
    var chainId = null;
    ...
    switch (parameters.version) {
      case eth_sig_util_namespaceObject.SignTypedDataVersion.V1:
        if (typeof parameters.data === "string") {
          external_assert_default().doesNotThrow(function () {
      ...
      case eth_sig_util_namespaceObject.SignTypedDataVersion.V4:
        ...
        external_assert_default().ok(data.primaryType in data.types, "Primary type of \"".concat(data.primaryType, "\" has no type definition."));
        var validation = external_jsonschema_default().validate(data, eth_sig_util_namespaceObject.TYPED_MESSAGE_SCHEMA.properties);
        ...
        if (chainId) {
          external_assert_default().ok(!Number.isNaN(activeChainId), "Cannot sign messages for chainId \"".concat(chainId, "\", because Web3Auth is switching networks."));

          if (typeof chainId === "string") {
            chainId = Number.parseInt(chainId, (0,base_namespaceObject.isHexStrict)(chainId) ? 16 : 10);
          }

          external_assert_default().strictEqual(chainId, activeChainId, "Provided chainId \"".concat(chainId, "\" must match the active chainId \"").concat(activeChainId, "\""));
        }

        break;

      default:
        external_assert_default().fail("Unknown typed data version \"".concat(parameters.version, "\""));
    }
  } catch (error) {
    throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidInput({
...
function ethPrivatekeyUtils_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function ethPrivatekeyUtils_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ethPrivatekeyUtils_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ethPrivatekeyUtils_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function _signTx() {
  _signTx = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee11(txParams, privKey, txFormatter) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 5:
            ...
            unsignedEthTx = tx_namespaceObject.TransactionFactory.fromTxData(finalTxParams, {
              common: common
            });
...
function ethPrivatekeyUtils_getProviderHandlers(_ref) {
  ...
  return {
    getAccounts: function () {
      var _getAccounts = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(_) {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", ["0x".concat((0,external_ethereumjs_util_namespaceObject.privateToAddress)(Buffer.from(privKey, "hex")).toString("hex"))]);
    ...
    getPrivateKey: function () {
      var _getPrivateKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(_) {
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
      ...
      var _processEthSignMessage = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5(msgParams, _) {
        ...
        return regenerator_default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                rawMessageSig = (0,base_controllers_namespaceObject.signMessage)(privKey, msgParams.data);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                sig = (0,eth_sig_util_namespaceObject.personalSign)({
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 7:
                ...
                finalChainId = Number.parseInt(chainId, (0,base_namespaceObject.isHexStrict)(chainId) ? 16 : 10);
                params = ethPrivatekeyUtils_objectSpread(ethPrivatekeyUtils_objectSpread({}, msgParams), {}, {
                ...
                sig = (0,eth_sig_util_namespaceObject.signTypedData)({
                  privateKey: privKeyBuffer,
                  data: data,
                  version: eth_sig_util_namespaceObject.SignTypedDataVersion.V1
                });
    ...
    processTypedMessageV3: function () {
      var _processTypedMessageV = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(msgParams, _) {
    ...
    processTypedMessageV4: function () {
      var _processTypedMessageV2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(msgParams, _) {
        var privKeyBuffer, providerEngineProxy, chainId, finalChainId, data, sig;
        return regenerator_default().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
    ...
    processEncryptionPublicKey: function () {
      var _processEncryptionPublicKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee10(address, _) {
        return regenerator_default().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                base_namespaceObject.log.info("processEncryptionPublicKey", address);
                return _context10.abrupt("return", (0,eth_sig_util_namespaceObject.getEncryptionPublicKey)(privKey));
    ...
    processDecryptMessage: function processDecryptMessage(msgParams, _) {
      ...
      var stripped = (0,external_ethereumjs_util_namespaceObject.stripHexPrefix)(msgParams.data);
      var buff = Buffer.from(stripped, "hex");
      var decrypted = (0,eth_sig_util_namespaceObject.decrypt)({
...
function hexToBn(inputHex) {
  if (external_ethereumjs_util_namespaceObject.BN.isBN(inputHex)) return inputHex;
  return new external_ethereumjs_util_namespaceObject.BN((0,external_ethereumjs_util_namespaceObject.stripHexPrefix)(inputHex), 16);
}
function BnMultiplyByFraction(targetBN, numerator, denominator) {
  var numberBN = new external_ethereumjs_util_namespaceObject.BN(numerator);
  var denomBN = new external_ethereumjs_util_namespaceObject.BN(denominator);
...
var TransactionFormatter = /*#__PURE__*/function () {
  function TransactionFormatter(_ref) {
    ...
    classCallCheck_default()(this, TransactionFormatter);
  ...
  createClass_default()(TransactionFormatter, [{
    key: "providerProxy",
    get: function get() {
    ...
    value: function () {
      var _getCommonConfiguration = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                hardfork = this.isEIP1559Compatible ? common_namespaceObject.Hardfork.London : common_namespaceObject.Hardfork.Berlin;
                customChainParams = {
                  name: name,
                ...
                return _context2.abrupt("return", common_default().custom(customChainParams));
    ...
    value: function () {
      var _formatTransaction = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(txParams) {
        ...
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                clonedTxParams = TransactionFormatter_objectSpread({}, txParams);
    ...
    value: function () {
      var _fetchEthGasPriceEstimate = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4() {
        var gasPrice;
        return regenerator_default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
    ...
    value: function () {
      var _getEIP1559Compatibility = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5() {
    ...
    value: function () {
      var _fetchGasFeeEstimateData = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6() {
    ...
    value: function () {
      var _getDefaultGasFees = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7(txParams) {
        var _yield$this$fetchGasF, gasFeeEstimates, gasEstimateType, _ref2, _ref2$medium, suggestedMaxPriorityFeePerGas, suggestedMaxFeePerGas, _yield$this$fetchEthG, gasPrice;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 5:
                ...
                _ref2 = gasFeeEstimates, _ref2$medium = _ref2.medium;
                _ref2$medium = _ref2$medium === void 0 ? {} : _ref2$medium;
                suggestedMaxPriorityFeePerGas = _ref2$medium.suggestedMaxPriorityFeePerGas, suggestedMaxFeePerGas = _ref2$medium.suggestedMaxFeePerGas;
              ...
              case 16:
                ...
                return _context7.abrupt("return", {
                  gasPrice: (0,external_ethereumjs_util_namespaceObject.addHexPrefix)(decGWEIToHexWEI(gasFeeEstimates.medium))
                });
    ...
    key: "estimateTxGas",
    value: function () {
      var _estimateTxGas = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(txMeta) {
        var txParams, gas;
        return regenerator_default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                txParams = TransactionFormatter_objectSpread({}, txMeta); // `eth_estimateGas` can fail if the user has insufficient balance for the
    ...
    key: "analyzeGasUsage",
    value: function () {
      var _analyzeGasUsage = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(txMeta) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 12:
                ...
                base_namespaceObject.log.warn(_context9.t0);
    ...
    value: function () {
      var _determineTransactionCategory = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee10(txParameters) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 12:
                ...
                base_namespaceObject.log.warn(_context10.t0);
    ...
    value: function () {
      var _getDefaultGasLimit = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee11(txParams) {
        ...
        return regenerator_default().wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.next = 2;
                return this.determineTransactionCategory(TransactionFormatter_objectSpread({}, txParams));
              ...
              case 9:
                ...
                return _context11.abrupt("return", (0,external_ethereumjs_util_namespaceObject.addHexPrefix)(TWENTY_ONE_THOUSAND.toString(16)));
              ...
              case 13:
                ...
                gasLimit = this.addGasBuffer((0,external_ethereumjs_util_namespaceObject.addHexPrefix)(estimatedGasHex), blockGasLimit);
...
function EthereumPrivateKeyProvider_createSuper(Derived) { var hasNativeReflectConstruct = EthereumPrivateKeyProvider_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function EthereumPrivateKeyProvider_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var EthereumPrivateKeyProvider = /*#__PURE__*/function (_BaseProvider) {
  inherits_default()(EthereumPrivateKeyProvider, _BaseProvider);

  var _super = EthereumPrivateKeyProvider_createSuper(EthereumPrivateKeyProvider);

  function EthereumPrivateKeyProvider(_ref) {
    var config = _ref.config,
        state = _ref.state;

    classCallCheck_default()(this, EthereumPrivateKeyProvider);
  ...
  createClass_default()(EthereumPrivateKeyProvider, [{
    key: "enable",
    value: function () {
      var _enable = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee() {
        return regenerator_default().wrap(function _callee$(_context) {
    ...
    key: "setupProvider",
    value: function () {
      var _setupProvider = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(privKey) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                providerHandlers = ethPrivatekeyUtils_getProviderHandlers({
                ...
                engine = new openlogin_jrpc_namespaceObject.JRPCEngine(); // Not a partial anymore because of checks in ctor
    ...
    key: "updateAccount",
    value: function () {
      var _updateAccount = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(params) {
        var existingKey;
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
    ...
    key: "switchChain",
    value: function () {
      var _switchChain = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4(params) {
    ...
    key: "lookupNetwork",
    value: function () {
      var _lookupNetwork = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5() {
        var chainId, network;
        return regenerator_default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                throw external_eth_rpc_errors_namespaceObject.ethErrors.rpc.invalidParams("chainId is required while lookupNetwork");
              ...
              case 7:
                ...
                throw external_eth_rpc_errors_namespaceObject.ethErrors.provider.chainDisconnected("Invalid network, net_version is: ".concat(network));
    ...
    value: function getChainSwitchMiddleware() {
      ...
      var chainSwitchHandlers = {
        addChain: function () {
          var _addChain = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6(params) {
        ...
        switchChain: function () {
          var _switchChain2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7(params) {
            var chainId;
            return regenerator_default().wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
    ...
    value: function getAccountMiddleware() {
      ...
      var accountHandlers = {
        updatePrivatekey: function () {
          var _updatePrivatekey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(params) {
            var privateKey;
            return regenerator_default().wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
...
defineProperty_default()(EthereumPrivateKeyProvider, "getProviderInstance", /*#__PURE__*/function () {
  var _ref2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(params) {
    var providerFactory;
    return regenerator_default().wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
