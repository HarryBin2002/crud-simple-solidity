...
var OpenloginAdapter = /*#__PURE__*/function (_BaseAdapter) {
  ...
  createClass_default()(OpenloginAdapter, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 9:
                ...
                base_namespaceObject.log.error("Failed to connect with openlogin provider", _context2.t0); // ready again to be connected
    ...
    value: function () {
      var _connectWithProvider = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6(params) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 25:
                ...
                _context6.next = 29;
                return this.openloginInstance.login(external_lodash_merge_default()(this.loginSettings, {
